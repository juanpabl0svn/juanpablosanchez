...
export const ui = {
    en: {
        ...
        "current": "Current",
        "experience.spider-security": "Contributed to the <strong>development</strong> and <strong>optimization</strong> of modules in <strong>\"Terque\"</strong> using <strong>CodeIgniter 4</strong> and <strong>PHP 8.3.2</strong>. Key achievements included:<br><ul><li><strong>Code modernization</strong> and updating outdated modules.</li><li><strong>Migration to microservices</strong> with <strong>NestJS</strong> and <strong>Spring Boot</strong>.</li><li><strong>Database optimization</strong> and microservice architecture improvements.</li><li><strong>Process automation</strong> with Azure DevOps.</li></ul> <strong>Improved efficiency</strong>, scalability, and platform stability.",
        "experience.dna-universe": "Led the development of a comprehensive club platform for <strong>\"Sefty\"</strong>, integrating <strong>Web 3.0</strong> technologies such as cryptocurrencies, NFTs, and AI to enhance user experience and platform capabilities. Key achievements:<br><ul><li><strong>Migrated to modern technologies</strong> like <strong>Next.js 14</strong> and <strong>NestJS</strong>, optimizing performance and scalability.</li><li><strong>Automated deployments</strong> with GitHub Actions and implemented <strong>NGINX</strong> as a reverse proxy and load balancer.</li><li><strong>Designed visually appealing interfaces</strong> aligned with \"Sefty’s\" brand identity using <strong>TailwindCSS</strong> and <strong>Figma</strong>.</li></ul>"
        ,
        "experience.heavy-mogul": "I developed and implemented key modules in the company’s enterprise applications, ensuring continuous updates and enhancing the user experience. Key achievements:<br><ul><li><strong>Optimization and continuous maintenance</strong> of applications, integrating new features to improve operational efficiency and customer experience.</li> <li><strong>Proactive application management</strong> through dashboards and logs, ensuring system stability and quick issue resolution.</li> <li><strong>Leadership of the IT team</strong>, setting strategic objectives and defining key performance indicators to measure progress and innovation within the company.</li> </ul>",
    ...
    es: {
        ...
        "current": "Actual",
        "experience.spider-security": "Contribuí al desarrollo y <strong>optimización</strong> de módulos en <strong>\"Terque\"</strong> usando <strong>CodeIgniter 4</strong> y <strong>PHP 8.3.2</strong>. Mis logros incluyeron:<br><ul><li><strong>Modernización de código</strong> y actualización de módulos obsoletos.</li><li><strong>Migración a microservicios</strong> con <strong>NestJS</strong> y <strong>Spring Boot</strong>.</li><li><strong>Optimización de bases de datos</strong> y arquitectura de microservicios.</li><li><strong>Automatización de procesos</strong> con Azure DevOps.</li></ul><strong>Mejoré la eficiencia</strong>, escalabilidad y estabilidad de la plataforma.",
        "experience.dna-universe": "Lideré el desarrollo de una plataforma integral para clubes de <strong>\"Sefty\"</strong>, integrando tecnologías de <strong>Web 3.0</strong> como criptomonedas, NFTs e IA para mejorar la experiencia del usuario y las capacidades de la plataforma. Principales logros:<br><ul><li><strong>Migración a tecnologías modernas</strong> como <strong>Next.js 14</strong> y <strong>NestJS</strong>, optimizando el rendimiento y la escalabilidad.</li><li><strong>Automatización de despliegues</strong> con GitHub Actions y configuración de <strong>NGINX</strong> como proxy inverso y balanceador de carga.</li><li><strong>Diseño de interfaces visuales</strong> atractivas alineadas con la identidad de marca de \"Sefty\" usando <strong>TailwindCSS</strong> y <strong>Figma</strong>.</li></ul>",
        "experience.heavy-mogul": "Desarrollé e implementé módulos clave en las aplicaciones empresariales de la compañía, asegurando su actualización constante y mejorando la experiencia del usuario. Principales logros:<br><ul><li><strong>Optimización y mantenimiento continuo</strong> de las aplicaciones, integrando nuevas funcionalidades para mejorar la eficiencia operativa y la experiencia del cliente.</li> <li><strong>Gestión proactiva de aplicaciones</strong> mediante dashboards y logs, garantizando la estabilidad del sistema y la rápida resolución de fallos.</li> <li><strong>Liderazgo del equipo de TI</strong>, estableciendo objetivos estratégicos y definiendo indicadores clave de desempeño para medir el progreso y la innovación dentro de la empresa.</li> </ul>",
